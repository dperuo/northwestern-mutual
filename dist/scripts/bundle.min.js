...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"nwm-user-list-container\">\n  <div class=\"row\">\n    <div class=\"col-xs-12\">\n      <h1 class=\"nwm-user-list-title\">{{ title }}</h1>\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-xs-12 text-right\">\n      <button type=\"button\" class=\"btn btn-link nwm-user-list-link\" ng-click=\"sortList()\">A&ndash;Z</button>|<button type=\"button\" class=\"btn btn-link nwm-user-list-link\" ng-click=\"sortList('reverse')\">Z&ndash;A</button>\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-xs-12\">\n      <ul class=\"media-list\">\n        <li class=\"media\" ng-repeat=\"user in results track by $index\">\n          <div class=\"media-left\">\n            <img class=\"media-object\" ng-src=\"{{user.picture.large}}\" alt=\"{{user.fullName}}\">\n          </div>\n          <div class=\"media-body media-middle\">\n            <h3 class=\"media-heading nwm-user-list-heading\">{{user.fullName}}</h3>\n          </div>\n        </li>\n      </ul>\n    </div>\n  </div>\n</div>\n";
